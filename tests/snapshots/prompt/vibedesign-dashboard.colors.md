...
Here is the **Color System** extracted from vibedesign.tech.
...
- brand-900: `#14095d`
**Semantic roles:**
- `#3a1df5` — **primary action**: CTAs, primary buttons, focus rings, active states. The color that says "act here." Use only at decision points.
