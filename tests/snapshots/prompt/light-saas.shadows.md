...
Here is the **Shape & Elevation System** extracted from northwind.io.
...
- **Colors:** `#ffffff` base, `#2563eb` primary action
- **Typography:** "Inter, -apple-system, sans-serif" headings
