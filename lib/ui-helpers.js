...
const PROVIDERS = {
  gemini: {
    ...
    models: [
      ...
      { id: 'gemini-2.5-pro',         label: 'Pro 2.5',        note: 'Paid · Stable'             },
      { id: 'gemini-3.1-pro-preview', label: '3.1 Pro',        note: 'Paid · Preview · Frontier' },
    ],
    defaultModel: 'gemini-2.5-flash',
    info: 'Flash 2.5 free (1,500 req/day) · 3.1 Pro is paid preview. <a href="https://aistudio.google.com/apikey" target="_blank">Get key →</a>',
  },
  claude: {
    name: 'Claude', color: '#d97706', placeholder: 'sk-ant-...',
    models: [
      { id: 'claude-opus-4-7',           label: 'Opus 4.7',   note: 'Paid · Frontier · Highest quality' },
      { id: 'claude-haiku-4-5-20251001', label: 'Haiku 4.5',  note: 'Paid · Fast · Low cost'            },
      { id: 'claude-sonnet-4-6',         label: 'Sonnet 4.6', note: 'Paid · Balanced'                   },
      { id: 'claude-opus-4-6',           label: 'Opus 4.6',   note: 'Paid · Previous frontier'          },
    ],
  ...
  openai: {
    ...
    models: [
      { id: 'gpt-4o-mini',  label: 'GPT-4o mini', note: 'Paid · Fast · Low cost' },
      { id: 'gpt-4o',       label: 'GPT-4o',      note: 'Paid · Balanced'        },
      { id: 'o4-mini',      label: 'o4-mini',     note: 'Paid · Reasoning'       },
    ],
