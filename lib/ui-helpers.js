...
async function handleAnalyze() {
  ...
  try {
    ...
    // Ensure URL is always the actual tab URL (content.js may report iframe URL in multi-frame sites)
    if (!_pageData.url || _pageData.url === 'about:blank') _pageData.url = tab.url || state.currentUrl;
