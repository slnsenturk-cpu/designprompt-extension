...
const IMAGE_PROFILE_PROMPT = [
  ...
  '  "iconography": { "style": "stroke | filled | mixed", "weight": "e.g. 1.5px", "corners": "rounded | sharp", "grid": "e.g. 24px" },',
  '  "illustration": "short description of illustration or texture style, or \"none\"",',
