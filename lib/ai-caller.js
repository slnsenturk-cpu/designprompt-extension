...
const IMAGE_PROFILE_PROMPT = [
  ...
  '    { "type": "glass | blur | glow | gradient | shadow | noise | grain", "where": "e.g. card bottom edge", "colour": "#rrggbb", "strength": "subtle | medium | strong", "description": "one or two sentences" }',
  '  ],',
  ...
  '  "evidence": { "palette": "strong | weak | insufficient", "typography": "...", "shape": "...", "iconography": "...", "illustration": "...", "density": "...", "mood": "...", "effects": "...", "container": "...", "hierarchy": "..." }',
  '}',
  '',
