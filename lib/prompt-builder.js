...
function resolvedPrimaryActionColor(data, style) {
  ...
  // Priority 1: button background — the actual rendered CTA color is ground truth.
  // CSS vars like --button-primary-border can be border/shadow colors, not the button face.
  if (isPlausibleHexColor(btnBg) && btnBg.toLowerCase() !== '#ffffff') return btnBg;
