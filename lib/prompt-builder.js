    ...
    if (scm.length > 0) {
      ...
      scm.forEach((sec, i) => {
        ...
        if (i === 1 && _hasMarquee && !_tickerInjected) {
          ...
          const _tickerBg = isDark ? '#000000' : '#ffffff';
          const _tickerBorder = isDark ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.06)';
          const _tickerColor = isDark ? 'rgba(240,237,230,0.5)' : 'rgba(0,0,0,0.4)';
