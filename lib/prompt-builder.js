  ...
  if(focus==='all') {
    ...
    if (scm.length > 0) {
      ...
      scm.forEach((sec, i) => {
        ...
        // Sidebar-switcher section details
        if (secType === 'sidebar-switcher') {
          ...
          lines.push(`  This is a state-driven feature showcase, NOT a static grid. Each panel should show distinct product UI content.`);
        }
        // Case grid details
