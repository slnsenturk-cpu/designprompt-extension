// lib/picker.js
// Element picker UI — injected on demand when picker mode is activated
// Depends on: content.js (window.__vibeDesign.extractElementData)
...
(function () {
  ...
  function createTooltip() {
    ...
    t.style.cssText = `position:fixed;pointer-events:none;z-index:2147483647;
      background:#18181b;color:#a5b4fc;
