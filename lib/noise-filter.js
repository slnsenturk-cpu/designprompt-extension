...
(function () {
  ...
  // Expose on shared namespace (used by content.js in target-page world)
  ...
  // Also expose as plain globals so sidepanel/popup scripts (prompt-builder.js)
  // can call them without drift-prone inline prefix lists.
  window.isNoisyVar = isNoisyVar;
  window.hasUsefulValue = hasUsefulValue;
})();
