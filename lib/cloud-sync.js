  ...
  async function migrateAnonymousHistory() {
    try {
      ...
      for (var i = 0; i < entries.length; i++) {
        ...
        var createdAt = (typeof entry.savedAt === 'number' && isFinite(entry.savedAt))
      ...
      console.log('[vd-cloud] migration complete:', migrated, 'migrated,', failed, 'failed');
      return { ok: migrated > 0, migrated: migrated, failed: failed };
    } catch (e) {
